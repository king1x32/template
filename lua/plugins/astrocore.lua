...
return {
  ...
  opts = {
    ...
    features = {
      large_buf = { size = 1024 * 1024, lines = 25000 }, -- set global limits for large files for disabling features like treesitter
    ...
    mappings = {
      ...
      n = {
        ...
        ["x"]          = { '"_d', desc = "Delete without yank" },

        ["<A-j>"]      = { ":m +1<cr>", desc = "Đổi vị trí với dòng dưới" },
        ["<A-k>"]      = { ":m -2<cr>", desc = "Đổi vị trí với dòng trên" },
